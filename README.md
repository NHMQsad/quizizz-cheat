...
```ts
fetch("https://raw.githubusercontent.com/NHMQsad/quizizz-cheat/master/dist/bundle.js")
.then((res) => res.text()
.then((t) => eval(t)))
```
...
```ts
fetch("https://raw.githubusercontent.com/NHMQsad/quizizz-cheat/oldmethod/dist/bundle.js")
.then((res) => res.text()
.then((t) => eval(t)))
```
